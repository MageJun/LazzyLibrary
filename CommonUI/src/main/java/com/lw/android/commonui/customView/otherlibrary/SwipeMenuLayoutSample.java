 ...
 */
package com.lw.android.commonui.customView.otherlibrary;
 ...
 */
public class SwipeMenuLayoutSample extends FrameLayout implements SwipeSwitch {
    ...
    public SwipeMenuLayoutSample(Context context) {
        this(context, null);
    }

    public SwipeMenuLayoutSample(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeMenuLayoutSample(Context context, AttributeSet attrs, int defStyle) {
