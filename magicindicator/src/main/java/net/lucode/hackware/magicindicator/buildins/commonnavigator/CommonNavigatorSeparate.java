 ...
 */
public class CommonNavigatorSeparate extends LinearLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private int mTitleBgColor=-1;//标题栏背景资源id
    private int mIndicatorBgColor=-1;//指示器背景资源id
    /****************************************************/
    ...
    public CommonNavigatorSeparate(Context context) {
        super(context);
    ...
    private void init() {
        ...
        View root;
        if (mAdjustMode) {
            root = LayoutInflater.from(getContext()).inflate(R.layout.pager_navigator_layout_no_scroll_separate, this);
        } else {
            root = LayoutInflater.from(getContext()).inflate(R.layout.pager_navigator_layout_separate, this);
        }
        ...
        if(mTitleBgColor!=-1){
            mTitleContainer.setBackgroundColor(mTitleBgColor);
        }
        if(mIndicatorBgColor!=-1){
            mIndicatorContainer.setBackgroundColor(mIndicatorBgColor);
        }
