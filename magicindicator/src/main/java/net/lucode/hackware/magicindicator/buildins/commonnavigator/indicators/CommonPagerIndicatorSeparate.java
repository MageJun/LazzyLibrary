...
public class CommonPagerIndicatorSeparate extends View implements IPagerIndicator {
    ...
    private static final String TAG = CommonPagerIndicatorSeparate.class.getSimpleName();
    ...
    public CommonPagerIndicatorSeparate(Context context) {
        super(context);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(getMode()==MODE_EXACTLY){
            float height = mDrawableHeight+mYOffset;
