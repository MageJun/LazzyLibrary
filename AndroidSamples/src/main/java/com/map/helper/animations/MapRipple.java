 ...
 */
package com.map.helper.animations;
...
public class MapRipple {
    ...
    private final Runnable mCircleOneRunnable = new Runnable() {
        ...
        public void run() {
            GroundOverlayOptions options = new GroundOverlayOptions()
                    ...
                    .dimensions((int)mDistance,(int)mDistance);
            mGroundOverlays[0]= (GroundOverlay) mBaiduMap.addOverlay(options);
          /*  mGroundOverlays[0] = mBaiduMap.addGroundOverlay(new GroundOverlayOptions()
                    .position(mLatLng*//*, (int) mDistance*//*)
                    .transparency(mTransparency)
                    .image(mBackgroundImageDescriptor));*/
            startAnimation(0);
    ...
    private void startAnimation(final int numberOfRipple) {
        ValueAnimator animator = ValueAnimator.ofInt(1, (int) mDistance);
