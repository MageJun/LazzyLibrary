package com.zed3.sipua.xydj.ui.groupinviteinfo.bean;

import java.io.Serializable;
import java.util.List;

public class GroupInviteSendDataMap {
    ...
    private List<GroupInviteSendData> mDatas;
    ...
    public List<GroupInviteSendData> getmDatas() {
        return mDatas;
    }

    public void setmDatas(List<GroupInviteSendData> mDatas) {
        this.mDatas = mDatas;
    }
    ...
    public static class GroupInviteSendData implements Serializable {
