 ...
 */
public class TimePickerViewExtend extends BasePickerView implements View.OnClickListener {

    private WheelTimeExtend wheelTime; //自定义控件
    private static final String TAG_SUBMIT = "submit";
    private static final String TAG_CANCEL = "cancel";

    public TimePickerViewExtend(PickerOptions pickerOptions) {
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        wheelTime = new WheelTimeExtend(timePickerView, mPickerOptions.type, mPickerOptions.textGravity, mPickerOptions.textSizeContent);
        if (mPickerOptions.timeSelectChangeListener != null) {
            wheelTime.setSelectChangeCallback(new ISelectTimeCallback() {
                @Override
                public void onTimeSelectChanged() {
                    try {
                        Date date = /*WheelTime.dateFormat.parse(wheelTime.getTime())*/wheelTime.getTimeOnlyDay();
                       if(mPickerOptions.startDate!=null){
                           if(date.getTime()<mPickerOptions.startDate.getTime().getTime()){
